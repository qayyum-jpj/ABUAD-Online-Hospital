...
$pgURL = $adminRoot."administrators";
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="bg-white rounded py-3 px-2">
                    <a href="<?= $adminRoot ?>administrators?min=true&do=create" class="btn btn-sm btn-outline-info rounded-circle"><i class="bi bi-plus"></i></a>
                    <a href="<?= $adminRoot ?>administrators" class="btn btn-sm btn-outline-info rounded-circle float-end"><i class="bi bi-bootstrap-reboot"></i></a>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="">
                            ...
                            <a href="<?= $adminRoot ?>administrators" class="float-end text-danger fw-bolder"><i class="bi bi-x fw-bold"></i></a>
                        </div>
                        ...
                        <div class="form-body">
                            ...
                            <form class="form form-vertical mt-3 mb-3 pb-3 border-bottom" action="" method="post">
                                ...
                                <div id="edit-username" class="row mt-3">
                                    <div class="col-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="userName" name="userName" placeholder="Username" value="<?php if(isset($_POST['userName'])){ echo $_POST['userName']; }else{ echo $dbUsername; } ?>">
                                            <label for="userName">Username</label>
                                        </div>
                                        <?php if(isset($userNameError)): ?><span class="d-inline-block bg-danger text-white px-2 rounded mt-1"><?= $userNameError ?></span><?php endif ?>
                                    </div>
                            ...
                            <form class="form form-vertical mb-3 pb-3 border-bottom" action="" method="post">
                                ...
                                <div id="edit-email" class="row mt-3">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="email" class="form-control" id="email" name="email" placeholder="Email Address" value="<?php if(isset($_POST['email'])){ echo $_POST['email']; }else{ echo $dbEmail; } ?>">
                                            <label for="email">Email Address</label>
                                        </div>
                                        <?php if(isset($emailError)): ?><span class="d-inline-block bg-danger text-white px-2 rounded mt-1"><?= $emailError ?></span><?php endif ?>
                                    </div>
            ...
            <div class="col-md-<?php if(isset($_GET['min']) && $_GET['min'] == 'true'){ echo 8; }else{ 12; } ?>">
                <div class="card">
                                        ...
                                        <div class="btn-group mb-1">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <a class="dropdown-item" href="<?= $adminRoot ?>administrators?id=<?= $row['id'] ?>&min=true&do=edit">Edit</a>
                                                    <a class="dropdown-item" href="<?= $adminRoot ?>administrators?id=<?= $row['id'] ?>&do=reset-pwd">Reset Password</a>
                                                    <a class="dropdown-item" href="<?= $adminRoot ?>administrators?id=<?= $row['id'] ?>&do=deactivate">Deactivate</a>
                                                    <?php else: ?>
                                                    <a class="dropdown-item" href="<?= $adminRoot ?>administrators?id=<?= $row['id'] ?>&do=activate">Activate</a>
                                                    <a class="dropdown-item" href="<?= $adminRoot ?>administrators?id=<?= $row['id'] ?>&do=delete">Delete</a>
                                                    <?php endif ?>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card-footer bg-transparent">
                        <a href="<?= $adminRoot ?>administrators?do=truncate" class="btn btn-sm btn-outline-warning">Truncate Administrators</a>
                    </div>
                </div>
            </div>
        </div>
