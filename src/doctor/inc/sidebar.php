<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link " href="<?= $doctorRoot ?>home">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?= $doctorRoot ?>temp">
