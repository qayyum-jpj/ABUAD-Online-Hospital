                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php if (isset($_GET['vw']) && $_GET['vw'] == 'overview') {
                                                        echo 'active';
                                                    } ?>" href="<?= $doctorRoot ?>profile?vw=overview">Overview</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link <?php if (isset($_GET['vw']) && $_GET['vw'] == 'e-info') {
                                                        echo 'active';
                                                    } ?>" href="<?= $doctorRoot ?>profile?vw=e-info">Edit Info</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link <?php if (isset($_GET['vw']) && $_GET['vw'] == 'e-image') {
                                                        echo 'active';
                                                    } ?>" href="<?= $doctorRoot ?>profile?vw=e-image">Edit Image</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link <?php if (isset($_GET['vw']) && $_GET['vw'] == 'c-pwd') {
                                                        echo 'active';
                                                    } ?>" href="<?= $doctorRoot ?>profile?vw=c-pwd">Change Password</a>
                            </li>
                                    ...
                                    <form action="" method="post">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                ...
                                                <div class="pt-2">
                                                    <a href="<?= $doctorRoot ?>profile?vw=e-image" class="btn btn-primary btn-sm" title="Upload new profile image"><i class="bi bi-upload"></i></a>
                                                    <?php if ($cuImage != $adminDefaultImg): ?>
                                                        <a href="<?= $doctorRoot ?>profile?vw=e-info&do=reset-image" class="btn btn-danger btn-sm" title="Reset image to default"><i class="bi bi-trash"></i></a>
                                                    <?php endif ?>
                                                </div>
                                            </div>
                                        </div>
