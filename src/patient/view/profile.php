                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php if (isset($_GET['vw']) && $_GET['vw'] == 'overview') {
                                                        echo 'active';
                                                    } ?>" href="<?= $patientRoot ?>profile?vw=overview">Overview</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link <?php if (isset($_GET['vw']) && $_GET['vw'] == 'e-info') {
                                                        echo 'active';
                                                    } ?>" href="<?= $patientRoot ?>profile?vw=e-info">Edit Info</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link <?php if (isset($_GET['vw']) && $_GET['vw'] == 'e-image') {
                                                        echo 'active';
                                                    } ?>" href="<?= $patientRoot ?>profile?vw=e-image">Edit Image</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link <?php if (isset($_GET['vw']) && $_GET['vw'] == 'c-pwd') {
                                                        echo 'active';
                                                    } ?>" href="<?= $patientRoot ?>profile?vw=c-pwd">Change Password</a>
                            </li>
                                    ...
                                    <form action="" method="post">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                ...
                                                <div class="pt-2">
                                                    <a href="<?= $patientRoot ?>profile?vw=e-image" class="btn btn-primary btn-sm" title="Upload new profile image"><i class="bi bi-upload"></i></a>
                                                    <?php if ($cuImage != $adminDefaultImg): ?>
                                                        <a href="<?= $patientRoot ?>profile?vw=e-info&do=reset-image" class="btn btn-danger btn-sm" title="Reset image to default"><i class="bi bi-trash"></i></a>
                                                    <?php endif ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <select class="form-select" name="country">
                                                    ...
                                                    while ($row = mysqli_fetch_array($q)) {
                                                    ?>
                                                        <option <?php if ($cuCountry == $row['id']) {
                                                                    echo 'selected';
                                                                } ?> value="<?= $row['id'] ?>"><?= $row['name'] ?></option>
                                                    <?php } ?>
                                                </select>
                                ...
                                <div class="tab-pane fade show active pt-3">
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <div class="input-group">
                                                    <input name="password" type="password" class="form-control" id="currentPassword" value="<?php if (isset($_POST['password'])) {
                                                                                                                                                echo $_POST['password'];
                                                                                                                                            } ?>">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <div class="input-group">
                                                    <input name="newPassword" type="password" class="form-control" id="newPassword" value="<?php if (isset($_POST['newPassword'])) {
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <div class="input-group">
                                                    <input name="newPassword2" type="password" class="form-control" id="newPassword2" value="<?php if (isset($_POST['newPassword2'])) {
