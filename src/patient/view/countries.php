        ...
        <div class="row">
            <div class="col-md-12">
                <div class="bg-white rounded py-3 px-2">
                    <a href="<?= $patientRoot ?>countries?min=true&do=create" class="btn btn-sm btn-outline-info rounded-circle"><i class="bi bi-plus"></i></a>
                    <a href="<?= $patientRoot ?>countries" class="btn btn-sm btn-outline-info rounded-circle float-end"><i class="bi bi-bootstrap-reboot"></i></a>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="">
                                ...
                                <a href="<?= $patientRoot ?>countries" class="float-end text-danger fw-bolder"><i class="bi bi-x fw-bold"></i></a>
                            </div>
                                        ...
                                        <div id="create" class="row mt-3">
                                            <div class="col-12 mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="countryName" name="countryName" placeholder="Country Name" value="<?php if (isset($_POST['countryName'])) {
                                        ...
                                        <div id="edit" class="row">
                                            <div class="col-12 mb-3">
                                                <div class="form-group">
                                                    <label for="countryName">Country Name</label>
                                                    <input type="text" id="countryName" class="form-control" name="countryName" value="<?php if (isset($_POST['countryName'])) {
                                                                                                                                            echo $_POST['countryName'];
                                                                                                                                        } else {
                                                                                                                                            echo $dbCountryName;
                                                                                                                                        } ?>">
            ...
            <div class="col-md-<?php if (isset($_GET['min']) && $_GET['min'] == 'true') {
                ...
                <div class="card">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <?php if ($row['status'] == 'active'): ?>
                                                            <a class="dropdown-item" href="<?= $patientRoot ?>countries?id=<?= $row['id'] ?>&min=true&do=edit">Edit</a>
                                                            <a class="dropdown-item" href="<?= $patientRoot ?>countries?id=<?= $row['id'] ?>&do=deactivate">Deactivate</a>
                                                        <?php else: ?>
                                                            <a class="dropdown-item" href="<?= $patientRoot ?>countries?id=<?= $row['id'] ?>&do=activate">Activate</a>
                                                            <a class="dropdown-item" href="<?= $patientRoot ?>countries?id=<?= $row['id'] ?>&do=delete">Delete</a>
                                                        <?php endif ?>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="card-footer bg-transparent">
                        <a href="<?= $patientRoot ?>countries?do=truncate" class="btn btn-sm btn-outline-warning">Truncate Countries</a>
                    </div>
                </div>
            </div>
        </div>
