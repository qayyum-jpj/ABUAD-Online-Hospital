    ...
    <section class="gallery" aria-labelledby="specialists-heading">
        ...
        <div class="gallery-container">
            ...
            <article class="gallery-item">
                <div class="card">
                    <div class="card-header">
                        <img src="./public/img/photo 5.jpg" alt="Dr. Mary Okoro">
                    </div>
                    <div class="card-body">
                        <p class="card-class">Neurologist</p>
                        <h3>Dr. Mary Okoro</h3>
                        <p style="color: #64748b; font-size: 0.9rem;">Expert in neuro-diagnostics and brain health.</p>
                    </div>
                    <a href="register.php" class="book-btn">Book Appointment</a>
                </div>
            </article>
            ...
            <article class="gallery-item">
                <div class="card">
                    <div class="card-header">
                        <img src="./public/img/photo 2.jpg" alt="Portrait of Dr. John Adewale" loading="lazy">
                    </div>
                    <div class="card-body">
                        <p class="card-class">Orthopedist</p>
                        <h3>Dr. John Adewale</h3>
                        <p style="color: #64748b; font-size: 0.9rem;">Expert in orthopedic care and joint health.</p>
                    </div>
                    <a href="register.php" class="book-btn">Book Appointment</a>
                </div>
            </article>
