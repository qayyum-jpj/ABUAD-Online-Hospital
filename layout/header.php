<?php include('./src/admin/inc/config.php') ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="./public/img/Ef3iqnGXgAIKpag-removebg-preview.png">
    ...
    <header>
        <nav aria-label="Main Navigation">
            ...
            <ul>
                ...
                <li><a href="<?= $mainRoot ?>book">Book Appointment</a></li>
                <!-- <li><a href="#about">About Us</a></li> -->
                <li><a href="<?= $adminRoot ?>login">Login</a></li>
            </ul>
        </nav>
    </header>